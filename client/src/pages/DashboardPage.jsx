                ...
                return (
                  ...
                  >
                    ...
                    {user.skillCertificates && user.skillCertificates.length > 0 && (
                      <div className="mb-4">
                        <p className={`text-xs ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} mb-2 font-medium`}>Skill Certificates ({user.skillCertificates.length})</p>
                        <div className="space-y-2">
                          {user.skillCertificates.slice(0, 3).map((cert, index) => (
                            cert.endsWith('.pdf') ? (
                              <a
                                key={index}
                                href={`${BASE_URL.replace('/api', '')}${cert}`}
                                target="_blank"
                              ...
                              >
                                ...
                                <span className="text-blue-400 text-xs font-semibold truncate">Certificate {index + 1}</span>
                              </a>
                            ) : (
                              <a
                                key={index}
                          ...
                          {user.skillCertificates.length > 3 && (
                            <p className="text-xs text-slate-400 text-center">+{user.skillCertificates.length - 3} more</p>
                          )}
                        </div>
                      </div>
                    )}
